...
const projects = [
  ...
  },
  {
    ...
    summary:
      "A product currently represented by a public launching-soon page. The public site is intentionally sparse, with a subscription form for updates rather than a full product announcement.",
    role:
      "I am keeping this page conservative until the public product story is ready to describe in more detail.",
    highlights: [
      "Public landing page is live at usemont.com.",
      "Current page collects email signups for launch updates.",
      "The internal portfolio page preserves the project URL even while the external site evolves.",
    ],
    postmortem:
      "For early products, the portfolio page should avoid over-claiming. The useful move is to reserve a durable project URL now, then expand the page later with product details, screenshots, launch notes, and lessons learned.",
  },
];
